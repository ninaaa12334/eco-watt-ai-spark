...
const steps = [
  { icon: ClipboardList, step: "01", title: "User Input", desc: "Appliance list, daily habits, standby behavior, monthly bill, home size, bill uploads, and device photos." },
  { icon: Brain, step: "02", title: "AI Analysis", desc: "Estimates consumption patterns, likely waste sources, suspicious bill behavior, and tariff anomalies." },
  { icon: BarChart3, step: "03", title: "Insights & Savings", desc: "Identifies biggest waste areas and estimates possible money and energy savings." },
  { icon: Zap, step: "04", title: "Action Plan", desc: "Personalized recommendations ranked by impact, plus bill verification and complaint tools." },
];
